...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Ghost-DMFT M=1 or 2, square lattice (ORIGINAL+GPU)')
    ...
    if args.out is None:
        args.out = f'ghost_dmft_square_M{args.M}_U{args.U}_t{args.t}_{args.mode}_ORIGINAL_gpu.dat'
